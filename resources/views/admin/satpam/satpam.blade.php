...
<div class="relative overflow-auto sm:rounded-lg p-4">
    ...
    <thead class="bg-[#1C3A6B] text-white">
        <tr>
            ...
            <th class="px-4 py-3 text-left whitespace-nowrap font-semibold">Shift Kerja</th>
            ...
            <th class="px-4 py-3 text-left whitespace-nowrap font-semibold">Lokasi Jaga</th>
    ...
    <tbody class="divide-y divide-gray-100">
        @if($satpamData)
            ...
            <tr class="hover:bg-gray-50 transition-all cursor-pointer satpam-row" data-url="{{ route('admin.satpam.detail', $satpam['satpam_id']) }}">
