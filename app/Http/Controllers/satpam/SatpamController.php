...
class SatpamController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            if ($request->hasFile('photo')) {
                ...
                $uploadPath = public_path('uploads/satpam');
    ...
    public function detail($id)
    {
        ...
        $satpamDetail['jenis_kelamin_text'] = GenderEnum::getLabelByValue((int)$satpamDetail['jenis_kelamin']);
        $satpamDetail['status_pernikahan_text'] = MaritalEnum::getLabelByValue((int)$satpamDetail['status_pernikahan']);
